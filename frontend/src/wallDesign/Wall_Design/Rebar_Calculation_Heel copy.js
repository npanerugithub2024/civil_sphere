...
// SHEAR KEY DESIGN
    const [shearResistanceFactor,setShearResistanceFactor ] = useState(0.5);
    const [shearKeyUnitWidth, setShearKeyUnitWidth] = useState(12);
    const [stirrupDiameter, setStirrupDiameter] = useState(0.5);
    const [stirrupSpacing, setStirrupSpacing] = useState(12);
    const [resistanceFactorLRDF_5_5_4_2_1, setResistanceFactorLRDF_5_5_4_2_1] = useState(0.9);
    
    const sheard = wallData.keydepth*12 - concreteCover - stirrupDiameter/2;
    const ka = 0.3
    const keyDesignShearForce = 1.5*0.5* ka* wallData.soilunitweight *((wallData.stemheight_H+ wallData.footingdepth_Hf + wallData.keydepth )**2 -(wallData.stemheight_H+ wallData.footingdepth_Hf  )**2)
    const equivalentStirrupAs = shearKeyUnitWidth/stirrupSpacing * Math.PI *0.25* (stirrupDiameter)**2;
    const keyShearResistance = 2 * sheard* shearKeyUnitWidth * (concreteCompressiveStrength*1000)**0.5/1000;
    const stirrupShearResistance = 0;
    const keyTotalShearResistance = (keyShearResistance + stirrupShearResistance)*resistanceFactorLRDF_5_5_4_2_1;
    const keyShearCheck = keyTotalShearResistance > keyDesignShearForce  ? " NOT GOOD" : "GOOD";

    const keyMn = (sheard-equivalentStirrupAs*rebarYieldStrength/(1.7* concreteCompressiveStrength* shearKeyUnitWidth))*equivalentStirrupAs*rebarYieldStrength;
    const keyNominalMomentCapacity = keyMn/12;
    const keyReducedNominalMomentCapacity = resistanceFactorLRDF_5_5_4_2_1* keyNominalMomentCapacity;
    ...
    <div>
        ...
        <div className = 'MinimumReinforcement'>
            ...
            <div>
                ...
                <p>Reduced Nominal Moment Capacity : {reducedNominalMomentCapacity.toFixed(2)} <i>kips-ft</i></p>
        ...
        <div className = 'CheckForShear'>
            <h3>CHECK SHEAR -- <i>LRDF 5.7.3.3</i></h3>
            <form>
                <div className="form-group">
        ...
        <div className = 'ShearKeyCheck'>
            ...
            <form>
                <div className="form-group">
                    <label htmlFor="shearResistanceFactor">Shear Resistance factor</label>
                    <input
                    type="number"
                    id="shearResistanceFactor"
                    name="shearResistanceFactor"
                    value={shearResistanceFactor}
                    onChange={e => setShearResistanceFactor(parseFloat(e.target.value))}
                    />
                </div>
                <div className="form-group">
                    <label htmlFor="shearKeyUnitWidth">Shear Key Unit Width</label>
                    <input
                    type="number"
                    id="shearKeyUnitWidth"
                    name="shearKeyUnitWidth"
                    value={shearKeyUnitWidth}
                    onChange={e => setShearKeyUnitWidth(parseFloat(e.target.value))}
                    />
                </div>
                <div className="form-group">
                    <label htmlFor="stirrupDiameter">Stirrup Diameter</label>
                    <input
                    type="number"
                    id="stirrupDiameter"
                    name="stirrupDiameter"
                    value={stirrupDiameter}
                    onChange={e => setStirrupDiameter(parseFloat(e.target.value))}
                    />
                </div>
                <div className="form-group">
                    <label htmlFor="stirrupSpacing">Stirrup Spacing</label>
                    <input
                    type="number"
                    id="stirrupSpacing"
                    name="stirrupSpacing"
                    value={stirrupSpacing}
                    onChange={e => setStirrupSpacing(parseFloat(e.target.value))}
                    />
                </div>
                <div className="form-group">
                    <label htmlFor="resistanceFactorLRDF_5_5_4_2_1">Stirrup Spacing</label>
                    <input
                    type="number"
                    id="resistanceFactorLRDF_5_5_4_2_1"
                    name="resistanceFactorLRDF_5_5_4_2_1"
                    value={resistanceFactorLRDF_5_5_4_2_1}
                    onChange={e => setResistanceFactorLRDF_5_5_4_2_1(parseFloat(e.target.value))}
                    />
                </div>
            </form>
            <div>
                <p>Design Shear Force : {keyDesignShearForce.toFixed(2)} <i>kips</i></p>
                <p>Euivalent Area of steel: {equivalentStirrupAs.toFixed(2)} <i>in2</i></p>
                <p>Concrete Shear Resistance: {keyShearResistance.toFixed(2)} <i>kips</i></p>
                <p>Stirrup Shear Resistance : {stirrupShearResistance.toFixed(2)} <i>kips</i></p>
                <p>Total Shear Resistance: {keyTotalShearResistance.toFixed(2)} <i>kips</i></p>
                <p>Shear Check. <b>{keyShearCheck}</b></p>     

                <p>Mn: {keyMn.toFixed(2)} <i>kips-in</i></p>
                <p>Nominal Moment Capacity: {keyNominalMomentCapacity.toFixed(2)} <i>kips-ft</i></p>
                <p>Reduced Nominal Moment Capacity: {keyReducedNominalMomentCapacity.toFixed(2)} <i>kips-ft</i></p>
                <p>Mu: {keyMu.toFixed(2)} <i>kips-ft</i></p>
                <p>MOMent Check. <b>{keyMomentCheck}</b></p>     
...
export default Rebar_Calculation_Heel;
